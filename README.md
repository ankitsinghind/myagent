...
### 5. OPTIONAL: Running the Email Watcher (IMAP Ingestion)
...
- **Security Chat Assistant**: Ask follow-up questions directly to the AI helper in the chat bubble (e.g., _"Why did we block this IP address?"_).
